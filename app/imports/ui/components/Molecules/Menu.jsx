...
import Link from '/imports/ui/components/Atoms/MenuLink';
...
const LockSvg = ({ isLocked }) => (
  ...
  >
    ...
    <path fill="#F4F4F7" d="M367,1077.8c0,10-7.5,18-16.7,18H7.7c-9.2,0-16.7-8.1-16.7-18V844.6c0-9.9,7.5-18,16.7-18h342.7c9.2,0,16.7,8.1,16.7,18L367,1077.8L367,1077.8z" />
        ...
        <CategoryList>
          {category.links.map(({ name, href, icon }) => (
            category.name === 'Options' ?
              ...
              /> :
              <Link name={name} href={href} active={isActive(url, href)} key={name + href} />
          ))}
        </CategoryList>
      </Category>
    ))}
